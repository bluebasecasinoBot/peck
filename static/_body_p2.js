        ...
        [
            __c(
                ...
                [
                    ...
                    __c('h1',{class:'rainbow_text',style:`font-family:sunrise;font-size:${__p(['_p2','__font'],{1:'70px'})['1']};`},['$PEKE']),
                    __c('h2',{class:'rainbow__text',style:`text-align:center;width:100%;font-size:${__p(['_p2','__font'],{2:'50px'})['2']}`},['Pekingese Beijing dog']),
                    __SYD.about_text_p2(),
                    __SYD.page1Socials(),
                    __c(
                        'div',
            ...
            __c(
                'div',
                {
                    style:`min-height:${__p(['_p2','_flex'],'row') === 'row' ? '100vh' : '300px'};width:${__p(['_p2','_flex'],'row') === 'row' ? '40%' : '100%'};background-image:url("./assets/main_front.png");background-size:contain;`//url("./assets/goatx.jpg")
                },[],
                {
...
__SYD.about_text_p2= () =>{
    return __c('p',{style:'font-size: 1.5rem;line-height: 1.75rem;text-align:left;font-weight:500;width:100%;text-align:center;'},[
        `While the Pekingese lounges in luxury, Tron is out there revolutionizing the decentralized space. Whether it's mastering the art of comfort or the future of tech, both are here to show us how it's done, each in their own unique way.`//,__c('span',{class:'rainbow__text'},[" $PEKE"])
    ])
}